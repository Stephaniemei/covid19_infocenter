...
var Ld=[C.B,C.J],Md=function(a){var b=a[C.Qd];b&&D(40);var c=a[C.Rd];c&&D(41);for(var d=Fa(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==C.Qd&&f!==C.Rd)if(-1<Ga(Ld,f)){var h=f,k=a[f],l=d[e];wd().set(h,k,l,"MY","MY-13",c)}else{}},Nd=function(a,b){for(var c in a)if(a.hasOwnProperty(c))if(-1<
...
Z.g.sdl=["google"],function(){function a(){return!!(Object.keys(l("horiz.pix")).length||Object.keys(l("horiz.pct")).length||Object.keys(l("vert.pix")).length||Object.keys(l("vert.pct")).length)}function b(w){for(var y=[],A=w.split(","),B=0;B<A.length;B++){var F=Number(A[B]);if(isNaN(F))return[];q.test(A[B])||y.push(F)}return y}function c(){var w=0,y=0;return function(){var A=Xd(),B=A.height;w=Math.max(v.scrollLeft+A.width,w);y=Math.max(v.scrollTop+B,y);return{Qg:w,Rg:y}}}function d(){u=W("self");
t=u.document;v=t.scrollingElement||t.body&&t.body.parentNode;z=c()}function e(w,y,A,B){var F=l(y),E={},H;for(H in F){E.Ua=H;if(F.hasOwnProperty(E.Ua)){var M=Number(E.Ua);w<M||(on({event:"gtm.scrollDepth","gtm.scrollThreshold":M,"gtm.scrollUnits":A.toLowerCase(),"gtm.scrollDirection":B,"gtm.triggers":F[E.Ua].join(",")}),Ol("sdl",y,function(N){return function(R){delete R[N.Ua];return R}}(E),{}))}E={Ua:E.Ua}}}function f(){var w=z(),y=w.Qg,A=w.Rg,B=y/v.scrollWidth*100,F=A/v.scrollHeight*100;e(y,"horiz.pix",
p.jc,r.Ee);e(B,"horiz.pct",p.ic,r.Ee);e(A,"vert.pix",p.jc,r.Re);e(F,"vert.pct",p.ic,r.Re);Nl("sdl","pending",!1)}function h(){var w=250,y=!1;t.scrollingElement&&t.documentElement&&u.addEventListener&&(w=50,y=!0);var A=0,B=!1,F=function(){B?A=hn(F,w):(A=0,f(),tn("sdl")&&!a()&&(md(u,"scroll",E),md(u,"resize",E),Nl("sdl","init",!1)));B=!1},E=function(){y&&z();A?B=!0:(A=hn(F,w),Nl("sdl","pending",!0))};return E}function k(w,y,A){if(y){var B=b(String(w));Ol("sdl",A,function(F){for(var E=0;E<B.length;E++){var H=
String(B[E]);F.hasOwnProperty(H)||(F[H]=[]);F[H].push(y)}return F},{})}}function l(w){return Pl("sdl",w,{})}function n(w){J(w.vtp_gtmOnSuccess);var y=w.vtp_uniqueTriggerId,A=w.vtp_horizontalThresholdsPixels,B=w.vtp_horizontalThresholdsPercent,F=w.vtp_verticalThresholdUnits,E=w.vtp_verticalThresholdsPixels,H=w.vtp_verticalThresholdsPercent;switch(w.vtp_horizontalThresholdUnits){case p.jc:k(A,y,"horiz.pix");break;case p.ic:k(B,y,"horiz.pct")}switch(F){case p.jc:k(E,y,"vert.pix");break;case p.ic:k(H,
y,"vert.pct")}tn("sdl")?Pl("sdl","pending")||(x||(d(),x=!0),J(function(){return f()})):(d(),x=!0,v&&(un("sdl"),Nl("sdl","pending",!0),J(function(){f();if(a()){var M=h();ld(u,"scroll",M);ld(u,"resize",M)}else Nl("sdl","init",!1)})))}var q=/^\s*$/,p={ic:"PERCENT",jc:"PIXELS"},r={Re:"vertical",Ee:"horizontal"},u,t,v,x=!1,z;(function(w){Z.__sdl=w;Z.__sdl.h="sdl";Z.__sdl.i=!0;Z.__sdl.priorityOverride=0})(function(w){w.vtp_triggerStartOption?n(w):Xl(function(){n(w)})})}();
...
Z.g.tl=["google"],function(){function a(b){return function(){if(b.zd&&b.Ad>=b.zd)b.wd&&W("self").clearInterval(b.wd);else{b.Ad++;var c=jn().getTime();on({event:b.M,"gtm.timerId":b.wd,"gtm.timerEventNumber":b.Ad,"gtm.timerInterval":b.interval,"gtm.timerLimit":b.zd,"gtm.timerStartTime":b.uf,"gtm.timerCurrentTime":c,"gtm.timerElapsedTime":c-b.uf,"gtm.triggers":b.Fh})}}}(function(b){Z.__tl=b;Z.__tl.h="tl";Z.__tl.i=!0;Z.__tl.priorityOverride=0})(function(b){J(b.vtp_gtmOnSuccess);if(!isNaN(b.vtp_interval)){var c=
{M:b.vtp_eventName,Ad:0,interval:Number(b.vtp_interval),zd:isNaN(b.vtp_limit)?0:Number(b.vtp_limit),Fh:String(b.vtp_uniqueTriggerId||"0"),uf:jn().getTime()};c.wd=W("self").setInterval(a(c),0>Number(b.vtp_interval)?0:Number(b.vtp_interval))}})}();
...
javaEnabled:!0,legacyHistoryImport:!0,nonInteraction:!0,useAmpClientId:!0,useBeacon:!0,storeGac:!0},q=function(x,z,w){var y=0,A;for(A in x)if(x.hasOwnProperty(A)&&(w&&l[A]||!w&&void 0===l[A])){var B=n[A]?Qa(x[A]):x[A];"anonymizeIp"!==A||B||(B=void 0);z[A]=B;y++}return y},p={name:k};q(c,p,!0);var r={"&gtm":Ij(!0)};q(c,r,!1);var u=encodeURI(uh("https:","http:","//www.google-analytics.com/"+(b.vtp_useDebugVersion?"u/analytics_debug.js":"analytics.js"),!!c.forceSSL));f("create",b.vtp_trackingId,p);f(h+
"set",r);f(h+"require",b.vtp_optimizeContainerId,{dataLayer:"dataLayer"});f(b.vtp_gtmOnSuccess);f(h+"require","render");a||(a=!0,O(u,function(){return si().loaded||b.vtp_gtmOnFailure()},b.vtp_gtmOnFailure));var t=W("dataLayer"),v=t&&t.hide;v&&(v.end||!0===v["GTM-N2D4V8S"])&&(v[b.vtp_optimizeContainerId]=!0)}else J(b.vtp_gtmOnFailure)})}();
